...
struct thread
  {
    ...
    struct semaphore process_loaded;    /* locks creating thread till the created
                                           one is loaded */
    bool *process_success;              /* process created without errors? */
    
    struct list opened_files ; /* list that hold opened file*/
